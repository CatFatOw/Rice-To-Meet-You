...
export const cities: City[] = [
  ...
  // Combined marker/viewpoint -- NYC and NJ share one metro dataset, so they
  // resolve to a single selectable city rather than two.
  { name: 'New York/New Jersey', latitude: 40.3856, longitude: -74.2059 },
